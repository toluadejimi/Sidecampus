...
<head>
    ...
    <style>
        ...
        .spinner {
            ...
            border-top: 6px solid rgb(7, 7, 243);
            border-radius: 50%;
            width: 50px;
            height: 50px;
...
<body style="padding: 0px; margin: 0px; background-color: #1100ff;">
                ...
                <form action="/charge?trx={{ $trx }}" method="POST" id="payment-form" class="my-5">
                    ...
                    <div class="products">
                        ...
                        <div class="item">
                            ...
                            <p class="item-name">1 Month Subscription</p>
                        </div>
                    ...
                    <div class="card-details">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                <button type="submit" class="btn btn-primary btn-block">Pay ${{ number_format($amount)
                                    }}</button>
                            </div>
                        </div>
                    </div>
