                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{ $data->expires_at }}</td>
                               @if ($data->status == 0)
                               <td><div class="badge badge-pill badge-danger">Inactive</div></td>
                               @else
                      ...
                      <table class="table mb-0 table-borderless">
                         ...
                         <tbody>
                            ...
                            <tr>
                               ...
                               <td>{{ $data->gender }}</td>
                                @if ($data->status == 0)
                                <td><div class="badge badge-pill badge-pending">Unverified</div></td>
                                @else
                                <td><div class="badge badge-pill badge-success">Verfied</div></td> 
                                @endif
